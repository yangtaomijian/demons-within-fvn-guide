...
- 关键剧情选择与存档建议 / Key story choices and save strategy
- 本源之轮全选项索引 / Full Essence Wheel choice index
- 常见问题 / FAQ
- CG 场景索引 / CG scene index
- 辞书与 Sprite Viewer 查漏 / Memory Codex and Sprite Viewer checklist

## 项目边界 / Project boundaries

《心魔在焉（Demons Within）》由 Sleth 创作。本攻略为非官方项目，与 Sleth 无隶属关系；仅跟进公开发布（Public）版本，不提供游戏本体，也不转载未经授权提取的游戏素材、完整辞书正文或第三方同人作品。

Demons Within is created by Sleth. This is an unofficial guide and is not affiliated with Sleth. It follows Public releases only and does not redistribute the game, unauthorized extracted game assets, full Memory Codex text, or third-party fan works.
